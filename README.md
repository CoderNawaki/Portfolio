...
- `portfolio/src/main/java/com/codernawaki/portfolio/`
  - controllers, contact service, models, and portfolio view data
- `portfolio/src/main/resources/templates/`
  - Thymeleaf templates
- `portfolio/src/main/resources/static/`
  - CSS, JavaScript, and static assets
- `portfolio/src/test/java/com/codernawaki/portfolio/`
